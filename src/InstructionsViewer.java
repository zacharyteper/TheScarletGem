...
public class InstructionsViewer extends JFrame
{
  ...
  public InstructionsViewer ()
  {
    ...
    screenshots[0].setBounds(580,350,200,200);
    try
    {
    ...
    screenshots[1].setBounds(580,350,200,200);
    try
    {
    ...
    screenshots[2].setBounds(580,350,200,200);
    try
    {
    ...
    screenshots[3].setBounds(580,350,200,200);
    try
    {
    ...
    screenshots[4].setBounds(580,300,200,200);
    try
    {
    ...
    screenshots[5].setBounds(580,350,200,200);
    try
    {
